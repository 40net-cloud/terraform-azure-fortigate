...
| Workflow | Status |
|---|---|
| Single | [![Single](https://github.com/40net-cloud/terraform-azure-fortigate/actions/workflows/tf-single.yml/badge.svg?branch=main)](https://github.com/40net-cloud/terraform-azure-fortigate/actions/workflows/tf-single.yml) |
| Active-Passive ELB/ILB | [![Active-Passive ELB-ILB](https://github.com/40net-cloud/terraform-azure-fortigate/actions/workflows/tf-active-passive-elb-ilb.yml/badge.svg?branch=main)](https://github.com/40net-cloud/terraform-azure-fortigate/actions/workflows/tf-active-passive-elb-ilb.yml) |
| Active-Passive SDN | [![Active-Passive SDN](https://github.com/40net-cloud/terraform-azure-fortigate/actions/workflows/tf-active-passive-sdn.yml/badge.svg?branch=main)](https://github.com/40net-cloud/terraform-azure-fortigate/actions/workflows/tf-active-passive-sdn.yml) |
| Active-Active ELB/ILB | [![Active-Active ELB-ILB](https://github.com/40net-cloud/terraform-azure-fortigate/actions/workflows/tf-active-active-elb-ilb.yml/badge.svg?branch=main)](https://github.com/40net-cloud/terraform-azure-fortigate/actions/workflows/tf-active-active-elb-ilb.yml) |
| Azure Virtual WAN | [![AzureVirtualWAN](https://github.com/40net-cloud/terraform-azure-fortigate/actions/workflows/tf-azurevirtualwan.yml/badge.svg?branch=main)](https://github.com/40net-cloud/terraform-azure-fortigate/actions/workflows/tf-azurevirtualwan.yml) |
