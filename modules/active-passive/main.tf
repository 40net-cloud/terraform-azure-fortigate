...
locals {
  ...
  lb_pools_ip_addresses_a = { for k, v in local.lb_pools_ip_addresses : k => v if v.name == "fgt-a" }
  lb_pools_ip_addresses_b = { for k, v in local.lb_pools_ip_addresses : k => v if v.name == "fgt-b" }
}
