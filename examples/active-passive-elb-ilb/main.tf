...
module "vnet" {
  ...
  subnet_names        = ["${var.prefix***REMOVED***-subnet-external", "${var.prefix***REMOVED***-subnet-internal", "${var.prefix***REMOVED***-subnet-hasync", "${var.prefix***REMOVED***-subnet-hamgmt"]
  vnet_name           = "${var.prefix***REMOVED***-vnet"
...
module "ilb" {
  ...
  lb_probe_unhealthy_threshold = 2
  lb_sku                       = "Standard"
  frontend_subnet_id           = module.vnet.vnet_subnets_name_id["${var.prefix***REMOVED***-subnet-internal"]
...
#  source = "../../modules/active-passive-elb-ilb"
  ...
  external_loadbalancer_name                      = "${var.prefix***REMOVED***-externalloadbalancer"
  external_loadbalancer_backend_address_pool_name = reverse(split("/", module.elb.azurerm_lb_backend_address_pool_id))[0]
  internal_loadbalancer_name                      = "${var.prefix***REMOVED***-internalloadbalancer"
